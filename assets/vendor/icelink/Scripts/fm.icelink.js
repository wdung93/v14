...
fm.icelink.baseLink = (function(superClass) {
  ...
  baseLink.prototype._onSendRTCP = null;

  baseLink.prototype._onSendRTP = null;
  ...
  function baseLink() {
    ...
    this.removeOnSendRTP = bind(this.removeOnSendRTP, this);
    this.removeOnSendRTCP = bind(this.removeOnSendRTCP, this);
    ...
    this.raiseSendRTP = bind(this.raiseSendRTP, this);
    this.raiseSendRTCP = bind(this.raiseSendRTCP, this);
    ...
    this.addOnSendRTP = bind(this.addOnSendRTP, this);
    this.addOnSendRTCP = bind(this.addOnSendRTCP, this);
  ...
  /*<span id='method-fm.icelink.baseLink-addOnSendRTCP'>&nbsp;</span> */
  ...
  /**
  	...
  	@function addOnSendRTCP
  	@param {fm.singleAction} value
  	@return {void}
   */

  baseLink.prototype.addOnSendRTCP = function() {
    var value;
    value = arguments[0];
    return this._onSendRTCP = fm.delegate.combine(this._onSendRTCP, value);
  };


  /*<span id='method-fm.icelink.baseLink-addOnSendRTP'>&nbsp;</span> */
  ...
  /**
  	...
  	@function addOnSendRTP
  	@param {fm.singleAction} value
  	@return {void}
   */

  baseLink.prototype.addOnSendRTP = function() {
    var value;
    value = arguments[0];
    return this._onSendRTP = fm.delegate.combine(this._onSendRTP, value);
  };
  ...
  baseLink.prototype.raiseSendRTCP = function() {
    var args2, error, exception, mediaIndex, negotiatedStream, onSendRTCP, p, packets, stream, streamIndex;
    packets = arguments[0];
    stream = arguments[1];
    streamIndex = arguments[2];
    mediaIndex = arguments[3];
    negotiatedStream = arguments[4];
    args2 = new fm.icelink.linkSendRTCPArgs();
    args2.setLink(this);
    args2.setConference(this.getConference());
    args2.setPackets(packets);
    args2.setStream(stream);
    ...
    args2.setDynamicProperties(this.getDynamicProperties());
    p = args2;
    onSendRTCP = this._onSendRTCP;
    if (!fm.global.equals(onSendRTCP, null)) {
      try {
        return onSendRTCP(p);
      } catch (error) {
        exception = error;
        if (!this.raiseUnhandledException(exception)) {
          return fm.asyncException.asyncThrow(exception, "Link -> OnSendRTCP");
        }
      } finally {
  ...
  baseLink.prototype.raiseSendRTP = function() {
    var args2, error, exception, i, mediaIndex, negotiatedStream, num, num2, onSendRTP, p, packet, stream, streamFormat, streams;
    packet = arguments[0];
    stream = arguments[1];
    mediaIndex = arguments[2];
    negotiatedStream = arguments[3];
    streamFormat = arguments[4];
    onSendRTP = this._onSendRTP;
    if (!fm.global.equals(onSendRTP, null)) {
      num = mediaIndex;
      ...
      while (i < num2) {
        try {
          if (!fm.global.equals(streams[i].getType(), stream.getType())) {
            num--;
          }
        } finally {
          i++;
      ...
      args2 = new fm.icelink.linkSendRTPArgs();
      args2.setLink(this);
      args2.setConference(this.getConference());
      args2.setPacket(packet);
      args2.setStream(stream);
      args2.setStreamIndex(num);
      args2.setMediaIndex(mediaIndex);
      args2.setNegotiatedStream(negotiatedStream);
      args2.setStreamFormat(streamFormat);
      args2.setDynamicProperties(this.getDynamicProperties());
      ...
      try {
        ...
        exception = error;
        if (!this.raiseUnhandledException(exception)) {
          return fm.asyncException.asyncThrow(exception, "Link -> OnSendRTP");
        }
      } finally {
  ...
  /*<span id='method-fm.icelink.baseLink-removeOnSendRTCP'>&nbsp;</span> */
  ...
  /**
  	...
  	@function removeOnSendRTCP
  	@param {fm.singleAction} value
  	@return {void}
   */

  baseLink.prototype.removeOnSendRTCP = function() {
    var value;
    value = arguments[0];
    return this._onSendRTCP = fm.delegate.remove(this._onSendRTCP, value);
  };


  /*<span id='method-fm.icelink.baseLink-removeOnSendRTP'>&nbsp;</span> */
  ...
  /**
  	...
  	@function removeOnSendRTP
  	@param {fm.singleAction} value
  	@return {void}
   */

  baseLink.prototype.removeOnSendRTP = function() {
    var value;
    value = arguments[0];
    return this._onSendRTP = fm.delegate.remove(this._onSendRTP, value);
  };
...
fm.icelink.linkDownArgs = (function(superClass) {
  ...
  linkDownArgs.prototype._retry = false;
  ...
  /*<span id='method-fm.icelink.linkDownArgs-getRetry'>&nbsp;</span> */
  ...
  linkDownArgs.prototype.getRetry = function() {
    return this._retry;
  };
  ...
  /*<span id='method-fm.icelink.linkDownArgs-setRetry'>&nbsp;</span> */
  ...
  linkDownArgs.prototype.setRetry = function() {
    var value;
    value = arguments[0];
...
fm.icelink.conference = (function(superClass) {
  ...
  conference.prototype._onLinkSendRTCP = null;

  conference.prototype._onLinkSendRTCPEvent = null;

  conference.prototype._onLinkSendRTP = null;

  conference.prototype._onLinkSendRTPEvent = null;
  ...
  function conference() {
    ...
    this.removeOnUnhandledException = bind(this.removeOnUnhandledException, this);
    this.removeOnLinkUp = bind(this.removeOnLinkUp, this);
    this.removeOnLinkSendRTP = bind(this.removeOnLinkSendRTP, this);
    this.removeOnLinkSendRTCP = bind(this.removeOnLinkSendRTCP, this);
    this.removeOnLinkReceiveSCTP = bind(this.removeOnLinkReceiveSCTP, this);
    this.removeOnLinkReceiveRTP = bind(this.removeOnLinkReceiveRTP, this);
    this.removeOnLinkReceiveRTCP = bind(this.removeOnLinkReceiveRTCP, this);
    ...
    this.raiseLinkSendRTP = bind(this.raiseLinkSendRTP, this);
    this.raiseLinkSendRTCP = bind(this.raiseLinkSendRTCP, this);
    ...
    this.processOnLinkSendRTP = bind(this.processOnLinkSendRTP, this);
    this.processOnLinkSendRTCP = bind(this.processOnLinkSendRTCP, this);
    ...
    this.addOnUnhandledException = bind(this.addOnUnhandledException, this);
    this.addOnLinkUp = bind(this.addOnLinkUp, this);
    this.addOnLinkSendRTP = bind(this.addOnLinkSendRTP, this);
    this.addOnLinkSendRTCP = bind(this.addOnLinkSendRTCP, this);
    this.addOnLinkReceiveSCTP = bind(this.addOnLinkReceiveSCTP, this);
    this.addOnLinkReceiveRTP = bind(this.addOnLinkReceiveRTP, this);
    this.addOnLinkReceiveRTCP = bind(this.addOnLinkReceiveRTCP, this);
    ...
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
      ...
      this._onLinkSendRTPEvent = this.processOnLinkSendRTP;
      this._onLinkSendRTCPEvent = this.processOnLinkSendRTCP;
  ...
  /*<span id='method-fm.icelink.conference-addOnLinkSendRTCP'>&nbsp;</span> */
  ...
  /**
  	...
  	@function addOnLinkSendRTCP
  	@param {fm.singleAction} value
  	@return {void}
   */

  conference.prototype.addOnLinkSendRTCP = function() {
    var value;
    value = arguments[0];
    return this._onLinkSendRTCP = fm.delegate.combine(this._onLinkSendRTCP, value);
  };


  /*<span id='method-fm.icelink.conference-addOnLinkSendRTP'>&nbsp;</span> */
  ...
  /**
  	...
  	@function addOnLinkSendRTP
  	@param {fm.singleAction} value
  	@return {void}
   */

  conference.prototype.addOnLinkSendRTP = function() {
    var value;
    value = arguments[0];
    return this._onLinkSendRTP = fm.delegate.combine(this._onLinkSendRTP, value);
  };
  ...
  conference.prototype.attachEvents = function() {
    ...
    link.removeOnSendRTP(this._onLinkSendRTPEvent);
    link.removeOnSendRTCP(this._onLinkSendRTCPEvent);
    ...
    link.addOnSendRTP(this._onLinkSendRTPEvent);
    link.addOnSendRTCP(this._onLinkSendRTCPEvent);
  ...
  conference.prototype.processOnLinkDown = function() {
    ...
    if (e.getRetry()) {
      return this.link(e.getLink().getPeerId(), e.getLink().getPeerState());
    }
  };
  ...
  conference.prototype.processOnLinkSendRTCP = function() {
    var e, error, exception;
    e = arguments[0];
    try {
      return this.raiseLinkSendRTCP(e);
    } catch (error) {
      exception = error;
      return fm.log.error("Could not raise link-sent RTCP packets.", exception);
    } finally {

    }
  };

  conference.prototype.processOnLinkSendRTP = function() {
    var e, error, exception;
    e = arguments[0];
    try {
      return this.raiseLinkSendRTP(e);
    } catch (error) {
      exception = error;
      return fm.log.error("Could not raise link-sent RTP packets.", exception);
    } finally {
  ...
  conference.prototype.raiseLinkSendRTCP = function() {
    var e, error, exception, onLinkSendRTCP;
    e = arguments[0];
    e.setConference(this);
    e.setDynamicProperties(this.getDynamicProperties());
    onLinkSendRTCP = this._onLinkSendRTCP;
    if (!fm.global.equals(onLinkSendRTCP, null)) {
      try {
        return onLinkSendRTCP(e);
      } catch (error) {
        exception = error;
        if (!this.raiseUnhandledException(exception)) {
          return fm.asyncException.asyncThrow(exception, "Conference -> OnLinkSendRTCP");
        }
      } finally {
  ...
  conference.prototype.raiseLinkSendRTP = function() {
    var e, error, exception, onLinkSendRTP;
    e = arguments[0];
    e.setConference(this);
    e.setDynamicProperties(this.getDynamicProperties());
    onLinkSendRTP = this._onLinkSendRTP;
    if (!fm.global.equals(onLinkSendRTP, null)) {
      try {
        return onLinkSendRTP(e);
      } catch (error) {
        exception = error;
        if (!this.raiseUnhandledException(exception)) {
          return fm.asyncException.asyncThrow(exception, "Conference -> OnLinkSendRTP");
        }
      } finally {
  ...
  /*<span id='method-fm.icelink.conference-removeOnLinkSendRTCP'>&nbsp;</span> */
  ...
  /**
  	...
  	@function removeOnLinkSendRTCP
  	@param {fm.singleAction} value
  	@return {void}
   */

  conference.prototype.removeOnLinkSendRTCP = function() {
    var value;
    value = arguments[0];
    return this._onLinkSendRTCP = fm.delegate.remove(this._onLinkSendRTCP, value);
  };


  /*<span id='method-fm.icelink.conference-removeOnLinkSendRTP'>&nbsp;</span> */
  ...
  /**
  	...
  	@function removeOnLinkSendRTP
  	@param {fm.singleAction} value
  	@return {void}
   */

  conference.prototype.removeOnLinkSendRTP = function() {
    var value;
    value = arguments[0];
    return this._onLinkSendRTP = fm.delegate.remove(this._onLinkSendRTP, value);
  };
