...
(function ($, window, document, undefined) {
    ...
    // function createWorkSheet(canvasObj) {
    //     // const regexp1 = /\\begin{document}(.*?)\\end{document}/g;
    //     const regexp = /\$(.*?)\$/g;

    //     const arraylatex = [...canvasObj.matchAll(regexp)];
    //     console.log(arraylatex);
    //     var onlyText = canvasObj.replaceAll(regexp, '  ');
        
    //     var canvasObjLine = onlyText.split('\n');
    //     for(var i = 0; i < canvasObjLine.length; i++) {

    //         var textbox = new fabric.Textbox(canvasObjLine[i], {
    //             fontSize: 20,
    ...
    //     for(var i = 0; i < arraylatex.length; i++) {

    //         if(arraylatex[i][1] === "") {
    //            return
    //         }
    
    //         var svg = latexToImg(arraylatex[i][1]);
    //         console.log(svg)
    //         fabric.Image.fromURL(svg, function (img) {
    //             img.set({
    //                 top: 100 + img.height*3,
    //                 left: 1000,
    //                 originX: 'center',
    //                 originY: 'center'
    //             })
    ...
    function createMediaID() {
        ...
        return `${today.getSeconds()}_${today.getMinutes()}_${today.getHours()}-${today.getDay()}_${today.getMonth()}_${today.getFullYear()}.json`;
    }
        ...
        canvas.on("mouse:down", function (opts) {
            ...
            if (target && target.type == "group-extended") {
                ...
                if (obj) {
                    ...
                    canvas.fire("selection:created", { target: obj });
                } else {
                    target._selectedObject = null;
                    canvas.fire("selection:created", { target: target });
                }
            ...
            if(object.type == 'textbox') {
                object.on('mouseup', function () {
                    ...
                    canvas.forEachObject(function (obj) {
                        if(obj.idWorkFlow == obj.idWorkFlow) {
                            objTop = obj.top,
                            objLeft = obj.left,
                    ...
                    let textbox = this;
                    let textForEditing1 = new fabric.Textbox(textbox.text, {
                        top: objTop + objHeight * objScaleY /2 - textbox.fontSize * objScaleY / 2 + textbox.top* objScaleY,
                        left: objLeft,
                        fontSize: textbox.fontSize * objScaleY,
                        fontFamily: textbox.fontFamily,
                        width: obj.width * objScaleX,
                        textAlign: "center",
                    ...
                    // textboxect.addWithUpdate();
        
                    textForEditing1.visible = true;
                    // do not give controls, do not allow move/resize/rotation on this 
                    textForEditing1.hasConstrols = false;
        
        
                    // now add this temporary textbox to canvas
                    canvas.add(textForEditing1);
                    canvas.setActiveObject(textForEditing1);
                    // make the cursor showing
                    textForEditing1.enterEditing();
                    textForEditing1.selectAll();
        
        
                    // editing:exited means you click outside of the textForEditing
                    textForEditing1.on('editing:exited', () => {
                        let newVal = textForEditing1.text;
                        let oldVal = textbox.text;
    ...
    function startActiveObject(obj) {
        ...
        try {
            ...
            // if (obj.WorkFlow) workFlowText(obj)
        } catch (error) {
            console.log(error);
        }
        // if (obj.blink) clockBlink(obj);
    ...
    function createTextBox(obj, idWorkFlow) {
    ...
    // var activityIMG1;
    // Thay đổi type từ group-extended thành group
    ...
    function createRectBox(obj, idWorkFlow) {

        var textbox = new fabric.Textbox('ABC', {
            fontSize: 12,
            fontFamily: 'Time New Roman',
            originX: 'center',
            originY: 'center',
        ...
        textbox.on('mouseup', function () {
            ...
            let textbox = this;
            let textForEditing1 = new fabric.Textbox(textbox.text, {
                top: objTop + objHeight * objScaleY / 2 - textbox.fontSize * objScaleY / 2,
                left: objLeft,
                fontSize: textbox.fontSize * objScaleY,
                fontFamily: textbox.fontFamily,
                width: obj.width * objScaleX,
        ...
        img1.className = 'activityIMG';
        img1.src = 'assets/images/notepad/Graphics3 (1).png';


        var activityIMG = new fabric.Image(img1, {
            originX: 'center',
            originY: 'center',
            left: -80,
            top: -70,
        ...
        activityIMG.on('mouseup', function () {
            // setDefaultAttributes(this)
            startActiveObject(this)
        });

        

        var img2 = document.createElement("img");
        img2.src = 'assets/images/notepad/trash.png';

        var trashIMG = new fabric.Image(img2, {
            originX: 'center',
            originY: 'center',
            left: 20,
            top: -70,
        ...
        img3.src = 'assets/images/notepad/clock1 (1).png';

        var clockIMG = new fabric.Image(img3, {
            originX: 'center',
            originY: 'center',
            left: -80,
            top: 70,
        ...
        // setDefaultAttributes(clockIMG);
        // startActiveObject(clockIMG);

        clockBlink(clockIMG)

        var img4 = document.createElement("img");
        img4.src = 'assets/images/notepad/copy.png';

        var copyIMG = new fabric.Image(img4, {
            originX: 'center',
            originY: 'center',
            left: -30,
            top: -70,
        ...
        var textbox1 = new fabric.Textbox('Text', {
            fontSize: 12,
            fontFamily: 'Time New Roman',
            originX: 'center',
            originY: 'center',
        ...
        // Thay đổi type từ group-extended thành group
        let group = new fabric.Group([obj, textbox, activityIMG, trashIMG, copyIMG, clockIMG, textbox1], {
            top: 100,
            left: 100,
            name: obj.type,
            type: "group",
    ...
    // $('#textBox1').on('mousedblclick', function(){
    //     alert('abc')
    // })

    function createPredefinedBox(obj, idWorkFlow) {
        var textbox = new fabric.Textbox('Text', {
            fontSize: 12,
            fontFamily: 'Time New Roman',
            originX: 'center',
        ...
        var arrowIMG = new fabric.Image(img4, {
            originX: 'center',
            originY: 'center',
            left: -60,
            top: -70,
        ...
        // Thay đổi type từ group-extended thành group
        let group = new fabric.Group([obj, rect, textbox, activityIMG, trashIMG, arrowIMG, clockIMG, textbox1], {
            top: 100,
            left: 100,
            name: obj.type,
            type: "group",
    ...
    function createConnectorBox(obj, idWorkFlow) {
        var textbox = new fabric.Textbox('Text', {
            fontSize: 12,
            fontFamily: 'Time New Roman',
            originX: 'center',
        ...
        // Thay đổi type từ group-extended thành group
        let group = new fabric.Group([obj, textbox, activityIMG, trashIMG, arrowIMG, clockIMG, textbox1], {
            top: 100,
            left: 100,
            name: obj.type,
            type: "group",
    ...
    function createEllipserBox(obj, idWorkFlow) {
        var textbox = new fabric.Textbox('Text', {
            fontSize: 12,
            fontFamily: 'Time New Roman',
            originX: 'center',
    ...
    function createGroupBox(obj, idWorkFlow) {
        var textbox = new fabric.Textbox('Text', {
            fontSize: 12,
            fontFamily: 'Time New Roman',
            originX: 'center',
    ...
    function iconRect(e) {
        ...
        var idWorkFlow = randomID();
        
        getTextForObject(createTextBox(rect, idWorkFlow));
    }
    ...
    function terminal(e) {
        ...
        var idWorkFlow = randomID();
        var group = createRectBox(rect, idWorkFlow);
        canvas.add(group);
        group.center().setCoords();
        group.set('idWorkFlow', idWorkFlow);
    ...
    function connector(e) {
        ...
        var idWorkFlow = randomID();
        var group = createConnectorBox(circle, idWorkFlow);
        canvas.add(group);
        group.center().setCoords();
        group.set('idWorkFlow', idWorkFlow);
        canvas.renderAll()
    ...
    function ellipse(e) {
        ...
        var idWorkFlow = randomID();
        var group = createEllipserBox(ellipse, idWorkFlow);
        canvas.add(group);
        group.center().setCoords();
        group.set('idWorkFlow', idWorkFlow);
        canvas.renderAll()
    ...
    function decision(e) {
        ...
        var idWorkFlow = randomID();
        var group = createGroupBox(rect, idWorkFlow);
        canvas.add(group);
        group.center().setCoords();
        group.set('idWorkFlow', idWorkFlow);
        canvas.renderAll()
    ...
    function inputOutput(e) {
        ...
        var idWorkFlow = randomID();
        var group = createConnectorBox(poly, idWorkFlow);
        canvas.add(group);
        group.center().setCoords();
        group.set('idWorkFlow', idWorkFlow);
        canvas.renderAll()
    ...
    function predefined(e) {
        ...
        var idWorkFlow = randomID();
        var group = createPredefinedBox(rect, idWorkFlow);
        canvas.add(group);
        group.center().setCoords();
        group.set('idWorkFlow', idWorkFlow);
        canvas.renderAll()
    ...
    var jsonObj = {"version":"5.2.1","objects":[{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":27,"top":9,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_l9yopu4x8","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":1},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#e0e0e0","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":106,"top":65.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":341,"top":8,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_8iz7i7loy","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":2},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#ebebeb","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Công nhân kho VNLog cắt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":1285,"top":9,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_c5i299dvh","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":3},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#f3f1f1","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Bộ phận kiểm đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":660,"top":6,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_7lo0hqkz2","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":4},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#f0efef","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Nhà cung cấp kiểm tra đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":972,"top":8,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_eh9r8nf4y","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":5},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#e8e8e8","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung Tâm Vận Hành Kho","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":28,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":341,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Công nhân kho VNLog cắt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":660,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Nhà cung cấp kiểm tra đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":972,"top":13.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung Tâm Vận Hành Kho","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":1285,"top":12.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Bộ phận kiểm đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":106,"top":65.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":28,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":341,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Công nhân kho VNLog cắt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":660,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Nhà cung cấp kiểm tra đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":972,"top":13.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung Tâm Vận Hành Kho","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":1285,"top":12.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Bộ phận kiểm đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":28,"top":6,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_l9yopu4x8","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":1},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#e0e0e0","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":106,"top":65.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":341,"top":8,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_8iz7i7loy","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":2},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#ebebeb","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Công nhân kho VNLog cắt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":1285,"top":7,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_c5i299dvh","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":3},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#f3f1f1","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Bộ phận kiểm đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":660,"top":6,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_7lo0hqkz2","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":4},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#f0efef","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Nhà cung cấp kiểm tra đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":972,"top":8,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_eh9r8nf4y","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":5},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#e8e8e8","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung Tâm Vận Hành Kho","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":28,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":341,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Công nhân kho VNLog cắt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":660,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Nhà cung cấp kiểm tra đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":972,"top":13.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung Tâm Vận Hành Kho","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":1285,"top":12.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Bộ phận kiểm đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":28,"top":6,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_l9yopu4x8","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":1},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#999","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":106,"top":65.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":341,"top":6,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_8iz7i7loy","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":2},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#999","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Công nhân kho VNLog cắt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":1285,"top":7,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_c5i299dvh","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":3},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#999","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Bộ phận kiểm đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":660,"top":6,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_7lo0hqkz2","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":4},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#999","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Nhà cung cấp kiểm tra đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"group","version":"5.2.1","originX":"left","originY":"top","left":972,"top":8,"width":286,"height":651,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":0,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"name":"rect","objectID":"_eh9r8nf4y","colorBorder":"#000","widthBorder":1,"curve":0,"hasShadow":true,"shadowObj":{"blur":30,"color":"#999","offsetX":0,"offsetY":0,"id":5},"fixed":false,"position":"front","isMoving":false,"isRepeat":false,"isDrawingPath":false,"speedMoving":1,"pathObj":null,"soundMoving":"","nameSoundMoving":"","blink":false,"lineStyle":"solid","select":false,"status":false,"colorText":"#000","colorTextSelected":"#000","colorSelected":"#ccc","colorUnselected":"#fff","soundSelected":"","nameSoundSelected":"","soundUnselected":"","nameSoundUnselected":"","input":false,"soundTyping":"","nameSoundTyping":"","snap":false,"soundSnap":"assets/song/snap.mp3","nameSoundSnap":"","objects":[{"type":"rect","version":"5.2.1","originX":"center","originY":"center","left":0,"top":0,"width":285,"height":650,"fill":"#fff","stroke":"#999","strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":{"color":"#999","blur":30,"offsetX":0,"offsetY":0,"affectStroke":false,"nonScaling":false},"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"rx":0,"ry":0},{"type":"textbox","version":"5.2.1","originX":"center","originY":"center","left":0,"top":-310,"width":285,"height":22.6,"fill":"#333","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":true,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung Tâm Vận Hành Kho","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}]},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":28,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung tâm đặt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":341,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Công nhân kho VNLog cắt hàng","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":660,"top":11.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Nhà cung cấp kiểm tra đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":972,"top":13.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Trung Tâm Vận Hành Kho","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false},{"type":"textbox","version":"5.2.1","originX":"left","originY":"top","left":1285,"top":12.5,"width":285,"height":22.6,"fill":"rgb(0,0,0)","stroke":null,"strokeWidth":1,"strokeDashArray":null,"strokeLineCap":"butt","strokeDashOffset":0,"strokeLineJoin":"miter","strokeUniform":false,"strokeMiterLimit":4,"scaleX":1,"scaleY":1,"angle":0,"flipX":false,"flipY":false,"opacity":1,"shadow":null,"visible":false,"backgroundColor":"","fillRule":"nonzero","paintFirst":"fill","globalCompositeOperation":"source-over","skewX":0,"skewY":0,"fontFamily":"Time New Roman","fontWeight":"normal","fontSize":20,"text":"Bộ phận kiểm đơn","underline":false,"overline":false,"linethrough":false,"textAlign":"center","fontStyle":"normal","lineHeight":1.16,"textBackgroundColor":"","charSpacing":0,"styles":{},"direction":"ltr","path":null,"pathStartOffset":0,"pathSide":"left","pathAlign":"baseline","minWidth":20,"splitByGrapheme":false}],"background":"#ffffff","backgroundColor":"#ffffff","id":1}

    function mileStone(e) {
        loadCanvasJsonNew(jsonObj);
    }
    ...
    $('#quiz-type').on('change', function () {
        ...
        if (quizType == 'quiz-1') {
            ...
            $('#worksheet')[0].style.display = 'inline-block';
            ...
            $('#worksheet')[0].style.display = 'none';
    ...
    $(function () {
        ...
        $('#mileStone').on('click', function () { mileStone(); });
        ...
        $("#terminal").on('click', function () { terminal(); });

        $("#process").on('click', function () { process(); });

        $("#connector").on('click', function () { connector(); });

        $("#decision").on('click', function () { decision(); });

        $("#inputOutput").on('click', function () { inputOutput(); });

        $("#polygon").on('click', function () { polygon(); });

        $("#predefined").on('click', function () { predefined(); });

        $("#ellipse").on('click', function () { ellipse(); });
        ...
        $("#worksheetMode").change(function (e) {
            var files = e.target.files,
                imageType = /image.*/;
            for (const file of files) {
                if (!file.type.match(imageType))
